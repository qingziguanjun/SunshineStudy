 ...
 */
package com.loveqiqi.sy.mysunshine.data;
    ...
    */
    public void testLocationTable() {
       ...
       long locationRowId = insertLocation(db);
        ...
        Cursor cursor = query.query(WeatherContract.LocationEntry.TABLE_NAME, null, null, null, null, null ,null);
        // Move the cursor to a valid database row
       assertTrue("Error:no reconr", cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
       // TestUtilities.validateCurrentRecord("Error,select not consisite", cursor, contentValues);
        assertFalse("more than one return", cursor.moveToNext());
